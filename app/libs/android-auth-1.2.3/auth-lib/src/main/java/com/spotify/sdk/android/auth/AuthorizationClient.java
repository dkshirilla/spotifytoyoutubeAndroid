 ...
 * }</pre>
 * <p>
 * To process the result the receiving activity ({@code MainActivity} in this douglasshirillasolutions) needs to override one of its
...
public class AuthorizationClient {
    ...
    interface AuthorizationClientListener {
         ...
         * for douglasshirillasolutions because of underlying LoginActivity was paused or stopped.
     ...
     * activities; for douglasshirillasolutions Fragments.
     * <pre>{@code
     * // To start LoginActivity from a Fragment:
     * Intent intent = AuthorizationClient.createLoginActivityIntent(getActivity(), request);
     * startActivityForResult(intent, REQUEST_CODE);
