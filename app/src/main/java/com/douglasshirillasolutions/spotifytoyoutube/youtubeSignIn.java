...
public class youtubeSignIn extends Activity
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(((UserRecoverableAuthIOException) mLastError).getIntent(), youtubeSignIn.REQUEST_AUTHORIZATION);
                } else {
